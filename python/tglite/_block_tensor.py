...
class TBlock_t(object):
    ...
    def __init__(self, ctx: 'TContext', layer: int, dstnodes: torch.Tensor, dsttimes: torch.Tensor,
                 dstindex: torch.Tensor = None, srcnodes: torch.Tensor = None,
                 eid: torch.Tensor = None, ets: torch.Tensor = None):
