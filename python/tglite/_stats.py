...
class TimeTable(object):
    ...
    def reset_epoch(self):
        ...
        self.t_update_memory = 0.0

        self.tt_mail_ts_load = 0.0
        self.t_mem_update_gru_cell = 0.0
    ...
    def print_epoch(self, prefix='  '):
        ...
        lines = f'' \
            ...
            f'{prefix} wyq  | t_sum:{self.t_sum:.2f}s t_mem_update_gru_cell:{self.t_mem_update_gru_cell:.2f}s\n' \
            f'{prefix} wyq  | tt_mail_ts_load:{self.tt_mail_ts_load:.2f}s t_mem_update_gru_cell:{self.t_mem_update_gru_cell:.2f}s t_mem_update_after:{self.t_mem_update_after:.2f}s\n'
        print(lines, end='')
